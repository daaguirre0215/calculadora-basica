...
indice = 0
entrada_texto = Entry(ventana, font= ('Impact 20'))
entrada_texto.grid(row=0, column=0, columnspan=4,padx=5, pady=5)
#ventana.iconbitmap("C:\\Users\\Orellana\\Desktop\   \calculator.ico")
...
boton_parentesis1 = Button(ventana, text="(", width= 5,height=2,command= lambda: click_boton("("))#Parantesis q abre
boton_parentesis2 = Button(ventana, text=")", width= 5,height=2,command= lambda: click_boton(")"))#Pararentesis q cierra
...
ventana.mainloop()# Reconoce todos los eventos que acontescan 
